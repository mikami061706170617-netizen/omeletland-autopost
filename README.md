...
## リール（動画）の自動投稿 — 2026-09-20 追加（2026-09-24 から毎日）
**毎日 20:00 トビリシ時間**（16:00 UTC）に、未投稿のリールを1本ずつ出す。
...
| `.github/workflows/reel.yml` | 毎日の実行 |
...
### 投稿
毎日 20:00 に **リール（フィードにも表示）＋ストーリーズ＋Facebook** に出す。
